...
from MainSite.models import Student, Skill
...
class StudentForm(forms.ModelForm):
    ...
    phone_number = forms.CharField(max_length=20, widget=forms.TextInput(attrs={'placeholder': '88005553535'}), label="Номер телефона")
    ...
    skills = forms.ModelMultipleChoiceField(queryset=Skill.objects.all(), required=False, label="Навыки")
...
class SortForm(forms.Form):
    ...
    ], required=False, widget=forms.Select(attrs={'class': 'form-control mr-2'}), initial='registration_date', label=False)
